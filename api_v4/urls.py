...
urlpatterns = [
    ...
    url(r'^user/(?P<user_id>[0-9]+)/posts/$', UserPostList.as_view(), name="post-list"),
    url(r'^user/(?P<user_id>[0-9]+)/posts/(?P<post_id>[0-9]+)/$', UserPostDetail.as_view(), name="post-detail"),
    url(r'^user/(?P<user_id>[0-9]+)/friends/posts/$', UserFriendsPostList.as_view(), name="friend-post"),
    url(r'^user/(?P<user_id>[0-9]+)/interests/posts/$', UserInterestsPostList.as_view(), name="interest-post"),
