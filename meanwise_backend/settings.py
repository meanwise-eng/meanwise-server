...
AMAZON_SNS_APP_NAME = os.environment.get(AMAZON_SNS_APP_NAME, 'Meanwise_Dev')
AMAZON_SNS_TOPIC_NAME =  os.environment.get(AMAZON_SNS_TOPIC_NAME, 'notification_dev')
AMAZON_SNS_PLATFORM_APNS = os.environment.get(AMAZON_SNS_PLATFORM_APNS, 'APNS_SANDBOX')
